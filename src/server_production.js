...
app.listen(PORT, () => {
  console.log(`✅ Server running on port ${PORT}`);
                               ...
                               // or ye rha mera server.js code const express = require('express');
...
// ===== BOT STARTUP CHECK =====
bot.getMe()
  .then(info => console.log(`🤖 Bot started as @${info.username}`))
  .catch(err => console.error('❌ Bot token invalid:', err.message));   update and give full code
